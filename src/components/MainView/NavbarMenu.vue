    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          <div class="flex items-center ms-3" ref="dropdownWrapper">
            <div>
              <button
                type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="/src/assets/img/user_default.png" alt="user photo" />
              </button>
            </div>
            <!-- Dropdown -->
            <div
              v-show="isDropdownOpen"
              class="z-50 fixed top-0 right-0 mt-16 w-48 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
              id="dropdown-user">
              ...
              <ul class="py-1" role="none">
                <li>
                  <router-link :to="{path: '/profile'}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                      <i class="pi pi-user mr-2" style="font-size: 1rem; color: #374151;" />
                      Mi perfil
                  </router-link>
                </li>
                <li>
                ...
                <li>
                  <a
                    ...
                    role="menuitem">
                    <i class="pi pi-sign-out mr-2" style="font-size: 1rem; color: #B91C1C;" />
                    Cerrar sesión
                  </a>
                </li>
              </ul>
...
const props = defineProps({
  signOutModalRef: { type: Object, default: () => ({}) },
});
